...
?>
                  ...
                  <tr>
                   ...
                   <td><?php echo $result['CreationDate']?></td>
                    <th>
     <a href="edit-services.php?editid=<?php echo $result['id'];?>" title="Edit Practice Area"> <i class="fa fa-edit" aria-hidden="true"></i> </a> | 
     <a href="manage-services.php?action=delete&&said=<?php echo $result['id']; ?>" style="color:red;" title="Delete this record" onclick="return confirm('Do you really want to delete this record?');"><i class="fa fa-trash" aria-hidden="true"></i> </a>
</th>
                  </tr>
         <?php 
$cnt++;
